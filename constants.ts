...
export const TRANSLATIONS: Record<string, Record<Language, string>> = {
  // Home
  guideTitle: { pt: "Desafio 30 Dias", en: "30 Day Challenge" },
  ...
  startBtn: { pt: "INICIAR DESAFIO", en: "START CHALLENGE" },
...
Remember: every body is unique and results may vary. Respect your limits and celebrate every achievement on your journey!` 
  ...
  // Menu
  menuTitle: { pt: "PAINEL DO DESAFIO", en: "CHALLENGE DASHBOARD" },
  ...
  // Workout
  workoutName: { pt: "Desafio 30D", en: "30D Challenge" },
